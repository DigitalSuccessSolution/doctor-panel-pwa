    ...
    <div className="space-y-6 animate-fadeIn pb-16 font-sans">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-white border border-slate-200/80 rounded-lg pl-11 pr-4 py-3 text-xs sm:text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-200 shadow-2xs"
        />
      </div>
