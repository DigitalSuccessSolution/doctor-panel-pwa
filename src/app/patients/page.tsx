      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2.5">
            ...
            <span className="inline-flex items-center gap-1 bg-[#A5D8FF]/30 text-[#1E4E70] text-xs font-semibold px-2.5 py-1 rounded-lg border border-[#A5D8FF]/60 whitespace-nowrap shrink-0">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100">
                ...
                <th className="p-4 text-[10px] font-bold text-slate-500 uppercase tracking-wider">Current Vitals</th>
                ...
                <tr key={child.id} className="hover:bg-slate-50/50 transition-colors text-xs">
                  ...
                  <td className="p-4">
                    <div className="space-y-0.5">
                      ...
                      {child.parentEmail && (
                        <span className="text-slate-400 block text-[10px]">{child.parentEmail}</span>
                      )}
                    </div>
                  </td>

                  {/* Column 4: Current Vitals */}
                  <td className="p-4">
                    <div className="space-y-0.5 font-medium text-slate-600">
                      <div>Weight: <span className="font-semibold text-slate-800">{child.weight || "N/A"} kg</span></div>
                      <div>Height: <span className="font-semibold text-slate-800">{child.height || "N/A"} cm</span></div>
                    </div>
                  </td>
            ...
            <div key={child.id} className="p-4 space-y-3.5 hover:bg-slate-50/50 transition-colors">
              ...
              <div className="grid grid-cols-2 gap-2 text-[11px] bg-slate-50 p-2.5 rounded-xl border border-slate-200/50">
                ...
                <div>
                  ...
                  <span className="text-slate-500 font-medium">{maskPhoneNumber(child.parentPhone)}</span>
                </div>
                <div className="col-span-2 pt-1.5 border-t border-slate-200/40">
                  <span className="text-slate-400 block uppercase text-[9px] font-bold">Current Vitals</span>
                  <span className="font-semibold text-slate-700">Wt: {child.weight || "N/A"} kg • Ht: {child.height || "N/A"} cm</span>
                </div>
              </div>
